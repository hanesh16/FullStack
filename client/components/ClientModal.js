...
const ClientModal = () => {
  ...
  const handleSubmit=(e)=>{
    ...
    addClient(name,email,phone,uname);
    setName('')
    setEmail('')
    setPhone('')
    setUname('')
  ...
  const [addClient]=useMutation(ADD_CLIENT,{
    variables:{name,email,phone,uname},
    update(cache,{
      data:{addClient}
    }){
        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <div className='mb-3'>
                ...
                <input type="text" className='form-control' id='uname' value={uname} onChange={(e)=>setUname(e.target.value)}/>
              </div>
              <div className='mb-3'>
